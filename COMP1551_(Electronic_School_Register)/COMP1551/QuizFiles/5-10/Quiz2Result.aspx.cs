...
{
    public partial class Quiz2Result : System.Web.UI.Page
    {
        ...
        {
            //get all grades with quizID = 2
            grades = gradeDAO.getAllGrades("2");
            int i = 0;
            HoF.Text = ("Top 10 Graded Students for Quiz 2" + "<br/>");
