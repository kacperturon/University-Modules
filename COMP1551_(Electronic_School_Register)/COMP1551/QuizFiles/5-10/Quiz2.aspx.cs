...
namespace COMP1551.ParentTools.QuizFiles._5_10
{
    public partial class Quiz2 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            quiz2 = quizDAO.getQuiz(2);
            //Cycle through Questions in Quiz1
            foreach (Question question in quiz2.Questions)
            {
        ...
        protected void Finish_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                grade = new Grade((total * 10) + "%", "2", DateTime.Now.ToString("d/M/yyyy"), child.ID);
                Session["grade"] = grade;
            ...
            Response.Redirect("~/QuizFiles/5-10/Quiz2Result.aspx");
        }
