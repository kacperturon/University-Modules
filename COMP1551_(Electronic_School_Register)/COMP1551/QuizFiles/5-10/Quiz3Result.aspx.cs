...
{
    public partial class Quiz3Result : System.Web.UI.Page
    {
        ...
        {
            //get all grades with quizID = 3
            grades = gradeDAO.getAllGrades("3");
            int i = 0;
            HoF.Text = ("Top 10 Graded Students for Quiz 3" + "<br/>");
