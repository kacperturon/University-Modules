...
namespace COMP1551.QuizFiles._5_10
{
    public partial class Quiz1 : System.Web.UI.Page
    {
        ...
        protected void Finish_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                //Send result to database and start new Session Grade
                GradeDAO gradeDAO = new GradeDAOImpl();
                grade = new Grade((total * 10) + "%", "1", DateTime.Now.ToString("d/M/yyyy"), child.ID);
                Session["grade"] = grade;
            ...
            Response.Redirect("~/QuizFiles/5-10/Quiz1Result.aspx");
        }

        //Getter & Setter for Quiz score Percentage
        public int Score
        {
            get { return score; }
            set { score = value; }
        ...
        //CheckedChanged and if so deselected others
