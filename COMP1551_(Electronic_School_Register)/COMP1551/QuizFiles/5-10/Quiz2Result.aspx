<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Quiz2Result.aspx.cs" Inherits="COMP1551.ParentTools.QuizFiles._5_10.Quiz2Result" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br />
    <br />
    <asp:Button ID="back" runat="server" Height="25px" OnClick="back_Click" Text="Quizzes" />
</asp:Content>