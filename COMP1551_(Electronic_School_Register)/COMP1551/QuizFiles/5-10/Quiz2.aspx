<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Quiz2.aspx.cs" Inherits="COMP1551.ParentTools.QuizFiles._5_10.Quiz2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h1><u>English Quiz</u></h1>
    <br />
    <h3>Question 1</h3>
    ...
    <br />
    <br />
    <asp:CheckBox ID="q1a1" runat="server" OnCheckedChanged="q1a1_CheckedChanged" AutoPostBack="true"/>
    <br />
    <br />
    <h3>Question 2</h3>
    ...
    <br />
    <br />
    <asp:CheckBox ID="q2a1" runat="server" OnCheckedChanged="q2o2_CheckedChanged" AutoPostBack="true"/>
    <br />
    <br />
    <asp:CheckBox ID="q2o3" runat="server" OnCheckedChanged="q2o3_CheckedChanged" AutoPostBack="true"/>
    <br />
    <br />
    <asp:CheckBox ID="q2o2" runat="server" OnCheckedChanged="q2a1_CheckedChanged" AutoPostBack="true"/>
    <br />
    <br />
    <h3>Question 3</h3>
    ...
    <br />
    <br />
    <asp:CheckBox ID="q7a1" runat="server" OnCheckedChanged="q7o3_CheckedChanged" AutoPostBack="true"/>
    <br />
    <br />
    <asp:CheckBox ID="q7o3" runat="server" OnCheckedChanged="q7a1_CheckedChanged" AutoPostBack="true"/>
    <br />
    <br />
    <h3>Question 8</h3>
    ...
    <br />
    <br />
    <asp:CheckBox ID="q9a1" runat="server" OnCheckedChanged="q9a1_CheckedChanged" AutoPostBack="true"/>
    <br />
    <br />
    <h3>Question 10</h3>
